...
*/
    public class BreakingTheRecords
    {
        ...
        {
            int minScore = scores[0], minScoreCount = 0, maxScore = scores[0], maxScoreCount = 0;

            //if the next one is greater and count
            ...
            //record the lowest and count
            return new[] { maxScoreCount, minScoreCount };
        }
    }
}
